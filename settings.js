...
global.owner = process.env.OWNER_NUMBER  || '263717672068' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=iQdWXLQA#DfFXvbYjoMPgAcybR2figQa4bc46_WWkP9yThzMQUz4' ,
